        ...
        <form runat="server" class="form_contact">
          ...
          <h2>Completa los datos</h2>
            <div class="user_info">
                ...
                <asp:Button runat="server" type="button" text="Registrar usuario" id="btnAsignar"  CssClass="BtnGuardar" OnClick="btnAsignar_Click"  OnClientClick="return confirm('¿Desea registrar este usuario?');"/>
